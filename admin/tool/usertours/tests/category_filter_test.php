...
final class category_filter_test extends \advanced_testcase {
    ...
    public static function filter_matches_provider(): array {
        return [
            ...
            'Parent category included, matching context' => [
                ['include' => ['{{CATEGORY1_ID}}']],
                'category:{{CATEGORY1_ID}}',
                true,
            ],
            'Parent category included, non-matching context' => [
                ['include' => ['{{CATEGORY1_ID}}']],
                'category:{{CATEGORY2_ID}}',
                false,
            ],
            'Parent category included, child category context' => [
                ['include' => ['{{CATEGORY1_ID}}']],
                'category:{{CHILD_CATEGORY1_ID}}',
                true,
            ],
            'Child category included, parent category context' => [
                ['include' => ['{{CHILD_CATEGORY1_ID}}']],
                'category:{{CATEGORY1_ID}}',
                false,
            ],
            'Child category included, matching context' => [
                ['include' => ['{{CHILD_CATEGORY1_ID}}']],
                'category:{{CHILD_CATEGORY1_ID}}',
                true,
            ],
            ...
            'Child category excluded, parent category context' => [
                ['exclude' => ['{{CHILD_CATEGORY1_ID}}']],
                'category:{{CATEGORY1_ID}}',
                true,
            ],
            'Parent included, child excluded' => [
                ['include' => ['{{CATEGORY1_ID}}'], 'exclude' => ['{{CHILD_CATEGORY1_ID}}']],
                'category:{{CHILD_CATEGORY1_ID}}',
                false,
            ],
            'Course in parent category, parent category included' => [
                ['include' => ['{{CATEGORY1_ID}}']],
                'course:{{COURSE1_ID}}',
                true,
            ],
            'Course in child category, parent category included' => [
                ['include' => ['{{CATEGORY1_ID}}']],
                'course:{{COURSE_CHILD1_ID}}',
                true,
            ],
            'Course in parent category, parent category excluded' => [
                ['exclude' => ['{{CATEGORY1_ID}}']],
                'course:{{COURSE1_ID}}',
                false,
            ],
            'Course in child category, child category excluded' => [
                ['exclude' => ['{{CHILD_CATEGORY1_ID}}']],
                'course:{{COURSE_CHILD1_ID}}',
                false,
            ],
            'Multiple categories included, matching one' => [
                ['include' => ['{{CATEGORY1_ID}}', '{{CATEGORY2_ID}}']],
                'category:{{CATEGORY1_ID}}',
                true,
            ],
            'Multiple categories excluded, matching none' => [
                ['exclude' => ['{{CATEGORY1_ID}}', '{{CATEGORY2_ID}}']],
                'category:{{CHILD_CATEGORY1_ID}}',
                false,
            ],
            'System context, categories included' => [
                ['include' => ['{{CATEGORY1_ID}}']],
                'system',
                false,
            ],
            'System context, categories excluded' => [
                ['exclude' => ['{{CATEGORY1_ID}}']],
                'system',
                true,
            ],
